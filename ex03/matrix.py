class Matrix():
    ...
    def __add__(self, other):
        if isinstance(other, Matrix) and self.size == other.size:
            ...
            self.my_return(f"{other} not a Matrix or 2 vector not same size")
    ...
    def __rsub__(self, other):
        if isinstance(other, Matrix):
            ...
            return Matrix(list)
        self.my_return(f"{other} not a Matrix")
    ...
    def __mul__(self, other):
        if isinstance(other, Matrix) and self.size == other.size:
            ...
            self.my_return(
                f"{other} not a Matrix or Int/float,or 2 vector not same size")
